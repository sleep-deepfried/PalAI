...
export function ImagePreview({
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-ivory overflow-hidden">
      {/* Enhanced Header with Gradient */}
      <div className="bg-gradient-to-br from-olive-500 via-olive-600 to-olive-700 text-white px-4 pt-8 pb-4 safe-area-top relative overflow-hidden flex-shrink-0">
        {/* Background Pattern */}
      ...
      <div className="flex-1 flex items-center justify-center p-4 overflow-hidden">
        <div className="relative w-full max-w-md aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl overflow-hidden shadow-xl border border-gray-200">
          <Image src={preview} alt="Preview" fill className="object-contain p-3" unoptimized />
        </div>
      </div>
      ...
      <div className="p-4 pb-20 bg-white border-t border-gray-100 flex-shrink-0">
        <div className="flex gap-3">
          ...
          <button
            onClick={onSubmit}
            disabled={isSubmitting}
            className="flex-1 py-4 bg-gradient-to-r from-olive-500 to-olive-600 text-white rounded-xl font-bold hover:from-olive-600 hover:to-olive-700 active:scale-[0.98] transition-all disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
          >
            {isSubmitting ? (
              <>
